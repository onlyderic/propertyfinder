...
<div class="container">
    ...
    <div class="bg-container">
        ...
        <div class="bg-search-content">
            <form id="frmsearch" action="<?php echo site_url('agent/my-properties'); ?>" method="post" accept-charset="UTF-8" class="form-horizontal">
                ...
                <div class="span10 form-inline">
                    ...
                    <div class="btn-group" data-toggle="buttons-checkbox">
                        <button type="button" class="search-ck btn <?php echo ( isset($propstate[PROPSTATUS_ACTIVE]) ? 'active' : '' ); ?>" data-mod="search-propstate" data-value="A">Published</button>
                        <button type="button" class="search-ck btn <?php echo ( isset($propstate[PROPSTATUS_DRAFT]) ? 'active' : '' ); ?>" data-mod="search-propstate" data-value="D">Drafted</button>
                    </div>
                    <div class="btn-group" data-toggle="buttons-checkbox">
                ...
                <div align="center">
                    <span style="display:none;">
                        <input type="checkbox" id="search-propstate-A" name="searchpropstate[]" value="A" <?php echo set_checkbox('searchpropstate[]', PROPSTATUS_ACTIVE, ( isset($propstate[PROPSTATUS_ACTIVE]) ? true: false ) ); ?> />
                        <input type="checkbox" id="search-propstate-D" name="searchpropstate[]" value="D" <?php echo set_checkbox('searchpropstate[]', PROPSTATUS_DRAFT, ( isset($propstate[PROPSTATUS_DRAFT]) ? true: false ) ); ?> />
        ...
        <div class="listing" align="center" onmouseover="$(this).find('div.listsort').show();" onmouseout="$(this).find('div.listsort').hide();">    
            ...
            <ul class="proplist">
                ...
                foreach($list as $rec) {
                    $data['record'] = $rec;
                    echo '<li>';
                    $this->load->view('properties/item_myproperties', $data); 
                    echo '</li>';   
                }
                ?>
            </ul>
...
head.ready(function() {
    urlpaginate = baseurl+'agent/search_more';
});
</script>