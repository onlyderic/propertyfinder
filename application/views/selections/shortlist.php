...
<div class="container">
    ...
    <div class="bg-container">
        ...
        <div class="bg-search-content">
            <form id="frmsearch" action="<?php echo site_url('shortlist'); ?>" method="post" accept-charset="UTF-8" class="form-horizontal">
        ...
        <div class="listing" align="center">    
            ...
            <div class="alert alert-block alert-error" align="center">
                <?php if($insearch) { ?>
                No matching properties were found on your shortlist. Modify your filters and search again.
                <?php } else { ?>
                You have not shortlisted any property yet.
                <?php } ?>
...
head.ready(function() {
    urlpaginate = baseurl+'shortlist/search_more';
});
</script>